...
class image_converter(QThread):
  ...
  def run(self):
    ...
    #image_topic="/camera_image/image_raw"#"/usb_cam/image_raw"
    ...
    #self.battery_sub = rospy.Subscriber(battery_topic,Float32,self.callback_battery)
...
class Ui_MainWindow(object):
    ...
    def start_video(self):
        ...
        #self.Imageupd = pyqtSignal(QImage)
        #self.Imageupd_slot(self.Imageupd)
        #self.Imageupd.connect(self.Imageupd_slot)
        #image_topic="/camera_image/image_raw"#"/usb_cam/image_raw"
        #image_topic="/camera/color/image_raw/compressed"
