...
# /vel_setpoint     -   Int32MultiArray     -   to festival-controller.py         -   Array of two motor velocity setpoints
...
class SerialComTeleop:
    ...
    def __init__(self):
        ...
        self.pub_vel_setpoint = rospy.Publisher("/vel_setpoint", Int32MultiArray, queue_size = 10)
        self.servo_msg = Int32MultiArray(data = [1500, 1500])
        self.setpoint_msg = Int32MultiArray(data = [0, 0])
    ...
    def publisherFunctions(self):
        ...
        self.pub_vel_setpoint.publish(Int32MultiArray(data=[0, 0]))
